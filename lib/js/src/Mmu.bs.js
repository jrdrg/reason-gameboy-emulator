...
var NotImplemented = Caml_exceptions.create("Mmu-GameboyEmulator.NotImplemented");
...
function read8(addr, param) {
          ...
          if (match !== 61440) {
            ...
            if (match$1 !== 3584) {
              if (match$1 !== 3840) {
                ...
                if (match$2 >= 64) {
                  exit$1 = match$2 >= 96 ? (
                      match$2 !== 112 && match$2 >= 97 ? 6 : 7
                    ) : (
                      match$2 !== 80 && match$2 >= 65 ? 6 : 7
                    );
                } else {
                  var switcher = match$2 - 16 | 0;
                ...
                switch (exit$1) {
                  ...
                  case 7 :
                      return /* tuple */[
                              Gpu$GameboyEmulator.read8(addr, gpu),
                              mmu
                            ];
  ...
  switch (exit) {
    ...
    case 4 :
        return /* tuple */[
                Caml_array.caml_array_get(mmu[/* externalRam */3], addr & 8191),
                mmu
              ];
    case 5 :
        return /* tuple */[
...
function write8(addr, v, param) {
  ...
  if (match >= 24577) {
    if (match >= 49152) {
      if (match >= 57344) {
                ...
                if (match$1 !== 3584) {
                      ...
                      case 6 :
                          throw [
                                ...
                                Curry._2(Printf.sprintf(/* Format */[
                                          ...
                                          "MMU write8 0xFF00: %x to %4x"
                                        ]), v, addr)
                              ];
                      case 7 :
                          return /* tuple */[
                                  mmu,
                                  Gpu$GameboyEmulator.write8(addr, v, gpu)
                                ];
                  ...
                  throw [
                        ...
                        Curry._2(Printf.sprintf(/* Format */[
                                  ...
                                  "GPU update OAM: %x to %x"
                                ]), v, addr)
                      ];
                }
              } else {
                exit$1 = match$1 !== 3072 && match$1 < 3328 ? 4 : 5;
              }
            } else {
              exit$1 = match$1 >= 2305 ? (
                  match$1 !== 2560 && match$1 < 2816 ? 4 : 5
                ) : (
                  match$1 !== 2048 && match$1 < 2304 ? 4 : 5
                );
            }
          } else {
            exit$1 = match$1 >= 769 ? (
                match$1 >= 1281 ? (
                    match$1 !== 1536 && match$1 < 1792 ? 4 : 5
                  ) : (
                    match$1 !== 1024 && match$1 < 1280 ? 4 : 5
                  )
              ) : (
                match$1 >= 257 ? (
                    match$1 !== 512 && match$1 < 768 ? 4 : 5
                  ) : (
                    match$1 !== 0 && match$1 < 256 ? 4 : 5
                  )
              );
          }
          switch (exit$1) {
            case 4 :
                throw [
                      ...
                      Curry._2(Printf.sprintf(/* Format */[
                                ...
                                "MMU write8 0xF000: %x to %x"
                              ]), v, addr)
                    ];
            case 5 :
                Caml_array.caml_array_set(mmu[/* workRam */4], addr & 8191, v);
                return /* tuple */[
                        mmu,
                        gpu
                      ];
        ...
        exit = match !== 53248 && match >= 49153 ? 1 : 3;
      }
    } else {
      var switcher$1 = match - 32768 | 0;
      if (switcher$1 > 4096 || switcher$1 < 0) {
        exit = switcher$1 !== -4096 ? 1 : 2;
      } else if (switcher$1 > 4095 || switcher$1 < 1) {
        Curry._2(Printf.printf(/* Format */[
                  /* String_literal */Block.__(11, [
                      "Writing to VRAM, addr  ",
                      /* Int */Block.__(4, [
                          /* Int_x */6,
                          /* No_padding */0,
                          /* No_precision */0,
  ...
  } else if (match > 4095 || match < 1) {
    console.log("Cart type something");
    return /* tuple */[
            mmu,
            gpu
          ];
