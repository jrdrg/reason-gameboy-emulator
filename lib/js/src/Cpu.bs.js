...
function ld_m_hl_b(s) {
  var match = ld_m_hl_8(s[/* cpu */0][/* registers */1][/* b */1], s);
  return newState(match[0], Caml_option.some(match[1]), match[2], s);
}

function ld_m_hl_c(s) {
  var match = ld_m_hl_8(s[/* cpu */0][/* registers */1][/* c */2], s);
  return newState(match[0], Caml_option.some(match[1]), match[2], s);
}

function ld_m_hl_d(s) {
  var match = ld_m_hl_8(s[/* cpu */0][/* registers */1][/* d */3], s);
  return newState(match[0], Caml_option.some(match[1]), match[2], s);
}

function ld_m_hl_e(s) {
  var match = ld_m_hl_8(s[/* cpu */0][/* registers */1][/* e */4], s);
  return newState(match[0], Caml_option.some(match[1]), match[2], s);
}

function ld_m_hl_h(s) {
  var match = ld_m_hl_8(s[/* cpu */0][/* registers */1][/* h */5], s);
  return newState(match[0], Caml_option.some(match[1]), match[2], s);
}

function ld_m_hl_l(s) {
  var match = ld_m_hl_8(s[/* cpu */0][/* registers */1][/* l */6], s);
  return newState(match[0], Caml_option.some(match[1]), match[2], s);
}
...
function ld_m_hl_n(s) {
  var gpu = s[/* gpu */2];
  var cpu = s[/* cpu */0];
  var match = Mmu$GameboyEmulator.read8(cpu[/* registers */1][/* pc */9], /* record */[
        /* gpu */gpu,
        /* mmu */s[/* mmu */1]
      ]);
