...
function ld_sp_nn(s) {
  ...
  var partial_arg = Caml_option.some(match[1]);
  var partial_arg$1 = incrementPc(2, machineCycles(3, setSp(match[0], cpu)));
  return (function (eta) {
              var param = undefined;
              var param$1 = eta;
              return newState(partial_arg$1, partial_arg, param, param$1);
...
function ld_sp_hl(s) {
  var cpu = s[/* cpu */0];
  var hl = rHl(cpu);
  var partial_arg = machineCycles(2, setSp(hl, cpu));
  return (function (eta) {
              var param = undefined;
              var param$1 = undefined;
              var param$2 = eta;
...
function ld_hl_sp_n(s) {
  ...
  var partial_arg = Caml_option.some(match[1]);
  var partial_arg$1 = incrementPc(1, machineCycles(3, (function (eta) {
                var param = undefined;
                var param$1 = eta;
...
function ld_a_m_n(s) {
  ...
  var partial_arg$2 = (function (eta) {
        ...
        var param$7 = eta;
        return setRegisters(partial_arg$1, param, param$1, param$2, param$3, param$4, param$5, param$6, param$7);
      })(incrementPc(1, machineCycles(2, cpu)));
  return (function (eta) {
              var param = undefined;
              var param$1 = eta;
              return newState(partial_arg$2, partial_arg, param, param$1);
...
function ld_a_m_hld(s) {
  ...
  var partial_arg$2 = (function (eta) {
        ...
        var param$7 = eta;
        return setRegisters(partial_arg$1, param, param$1, param$2, param$3, param$4, param$5, param$6, param$7);
      })(decrementHl(machineCycles(2, cpu)));
  return (function (eta) {
              var param = undefined;
              var param$1 = eta;
              return newState(partial_arg$2, partial_arg, param, param$1);
...
function ld_a_m_hli(s) {
  ...
  var partial_arg$2 = (function (eta) {
        ...
        var param$7 = eta;
        return setRegisters(partial_arg$1, param, param$1, param$2, param$3, param$4, param$5, param$6, param$7);
      })(incrementHl(machineCycles(2, cpu)));
  return (function (eta) {
              var param = undefined;
              var param$1 = eta;
              return newState(partial_arg$2, partial_arg, param, param$1);
...
function inc_hl(s) {
  var partial_arg = machineCycles(2, incrementHl(s[/* cpu */0]));
  return (function (eta) {
              var param = undefined;
              var param$1 = undefined;
              var param$2 = eta;
...
function inc_sp(s) {
  var partial_arg = machineCycles(2, incrementSp(undefined, s[/* cpu */0]));
  return (function (eta) {
              var param = undefined;
              var param$1 = undefined;
              var param$2 = eta;
...
function dec_hl(s) {
  ...
  var partial_arg = machineCycles(2, cpu);
  return (function (eta) {
              var param = undefined;
              var param$1 = undefined;
              var param$2 = eta;
...
function dec_sp(s) {
  var partial_arg = machineCycles(2, decrementSp(undefined, s[/* cpu */0]));
  return (function (eta) {
              var param = undefined;
              var param$1 = undefined;
              var param$2 = eta;
...
function jp_nn(s) {
  ...
  var partial_arg = Caml_option.some(match[1]);
  var partial_arg$1 = machineCycles(3, cpu);
  return (function (eta) {
              var param = undefined;
              var param$1 = eta;
              return newState(partial_arg$1, partial_arg, param, param$1);
...
function jp_m_hl(s) {
  ...
  var partial_arg = Caml_option.some(s[/* mmu */1]);
  var partial_arg$1 = machineCycles(4, cpu);
  return (function (eta) {
              var param = undefined;
              var param$1 = eta;
              return newState(partial_arg$1, partial_arg, param, param$1);
...
function jp_nz_nn(s) {
  ...
  cpu[/* registers */2][/* pc */9] = match[0];
  var partial_arg = Caml_option.some(match[1]);
  var partial_arg$1 = machineCycles(match[2], cpu);
  return (function (eta) {
              var param = undefined;
              var param$1 = eta;
              return newState(partial_arg$1, partial_arg, param, param$1);
...
function call_nz_nn(s) {
  ...
  var partial_arg = Caml_option.some(match[1]);
  var partial_arg$1 = machineCycles(match[2], setPc(match[0], cpu));
  return (function (eta) {
              var param = undefined;
              var param$1 = eta;
              return newState(partial_arg$1, partial_arg, param, param$1);
...
function cb(s) {
  ...
  var partial_arg = Caml_option.some(match[1]);
  var partial_arg$1 = incrementPc(1, cpu);
  return (function (eta) {
              var param = undefined;
              var param$1 = eta;
              return newState(partial_arg$1, partial_arg, param, param$1);
