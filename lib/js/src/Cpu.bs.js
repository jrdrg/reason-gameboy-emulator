...
function load_nn_8(register, s) {
  var match = readAndIncrementPc(s[/* cpu */0]);
  var cpu = match[1];
  ...
  switch (register) {
    ...
    case 1 : 
        var arg = value;
        cpu$1 = machineCycles(2, (function (param) {
    ...
    case 2 : 
        var arg$1 = value;
        cpu$1 = machineCycles(2, (function (param, param$1) {
                    return (function (param$2, param$3, param$4, param$5, param$6, param$7) {
                        return setRegisters(param, param$1, arg$1, param$2, param$3, param$4, param$5, param$6, param$7);
                      });
                  })(undefined, undefined)(undefined, undefined, undefined, undefined, undefined, cpu));
        break;
    case 3 : 
        var arg$2 = value;
        cpu$1 = machineCycles(2, (function (param, param$1, param$2) {
                    return (function (param$3, param$4, param$5, param$6, param$7) {
                        return setRegisters(param, param$1, param$2, arg$2, param$3, param$4, param$5, param$6, param$7);
                      });
                  })(undefined, undefined, undefined)(undefined, undefined, undefined, undefined, cpu));
        break;
    case 4 : 
        var arg$3 = value;
        cpu$1 = machineCycles(2, (function (param, param$1, param$2, param$3) {
                    return (function (param$4, param$5, param$6, param$7) {
                        return setRegisters(param, param$1, param$2, param$3, arg$3, param$4, param$5, param$6, param$7);
                      });
                  })(undefined, undefined, undefined, undefined)(undefined, undefined, undefined, cpu));
        break;
    case 5 : 
    ...
    case 6 : 
        var arg$4 = value;
        cpu$1 = machineCycles(2, (function (param, param$1, param$2, param$3, param$4) {
                    return (function (param$5, param$6, param$7) {
                        return setRegisters(param, param$1, param$2, param$3, param$4, arg$4, param$5, param$6, param$7);
                      });
                  })(undefined, undefined, undefined, undefined, undefined)(undefined, undefined, cpu));
        break;
    case 7 : 
        var arg$5 = value;
        cpu$1 = machineCycles(2, (function (param, param$1, param$2, param$3, param$4, param$5) {
                    return (function (param$6, param$7) {
                        return setRegisters(param, param$1, param$2, param$3, param$4, param$5, arg$5, param$6, param$7);
                      });
                  })(undefined, undefined, undefined, undefined, undefined, undefined)(undefined, cpu));
        break;
    
  }
  return newState(cpu$1, Caml_option.some(match$1[1]), undefined, s);
}
                  ...
                  return setFlag$1(/* C */3, 0, param, param$1);
                      ...
                      return setFlag$1(/* H */2, 0, param, param$1);
                          ...
                          return setFlag$1(/* N */1, 0, param, param$1);
                              ...
                              var param = undefined;
                              var param$1 = eta;
                              return setFlag$1(/* Z */0, fZ, param, param$1);
                            })(cpu)))));
}

function or_a(s) {
  var cpu = s[/* cpu */0];
  var cpu$1 = or_(cpu, cpu[/* registers */2][/* a */0]);
  return newState(machineCycles(1, cpu$1), undefined, undefined, s);
}

function or_b(s) {
  var cpu = s[/* cpu */0];
  var cpu$1 = or_(cpu, cpu[/* registers */2][/* b */1]);
  return newState(machineCycles(1, cpu$1), undefined, undefined, s);
}

function or_c(s) {
  var cpu = s[/* cpu */0];
  var cpu$1 = or_(cpu, cpu[/* registers */2][/* c */2]);
  return newState(machineCycles(1, cpu$1), undefined, undefined, s);
}

function or_d(s) {
  var cpu = s[/* cpu */0];
  var cpu$1 = or_(cpu, cpu[/* registers */2][/* d */3]);
  return newState(machineCycles(1, cpu$1), undefined, undefined, s);
}

function or_e(s) {
  var cpu = s[/* cpu */0];
  var cpu$1 = or_(cpu, cpu[/* registers */2][/* e */4]);
  return newState(machineCycles(1, cpu$1), undefined, undefined, s);
}

function or_h(s) {
  var cpu = s[/* cpu */0];
  var cpu$1 = or_(cpu, cpu[/* registers */2][/* h */5]);
  return newState(machineCycles(1, cpu$1), undefined, undefined, s);
}

function or_l(s) {
  var cpu = s[/* cpu */0];
  var cpu$1 = or_(cpu, cpu[/* registers */2][/* l */6]);
  return newState(machineCycles(1, cpu$1), undefined, undefined, s);
}
...
function or_m_hl(s) {
  ...
  return newState(machineCycles(2, cpu$1), Caml_option.some(match[1]), undefined, s);
}
...
function or_n(s) {
  ...
  return newState(machineCycles(2, cpu), Caml_option.some(match$1[1]), undefined, s);
}
...
function xor_a(s) {
  var cpu = s[/* cpu */0];
  var cpu$1 = xor_(cpu, cpu[/* registers */2][/* a */0]);
  return newState(machineCycles(1, cpu$1), undefined, undefined, s);
}

function xor_b(s) {
  var cpu = s[/* cpu */0];
  var cpu$1 = xor_(cpu, cpu[/* registers */2][/* b */1]);
  return newState(machineCycles(1, cpu$1), undefined, undefined, s);
}

function xor_c(s) {
  var cpu = s[/* cpu */0];
  var cpu$1 = xor_(cpu, cpu[/* registers */2][/* c */2]);
  return newState(machineCycles(1, cpu$1), undefined, undefined, s);
}

function xor_d(s) {
  var cpu = s[/* cpu */0];
  var cpu$1 = xor_(cpu, cpu[/* registers */2][/* d */3]);
  return newState(machineCycles(1, cpu$1), undefined, undefined, s);
}

function xor_e(s) {
  var cpu = s[/* cpu */0];
  var cpu$1 = xor_(cpu, cpu[/* registers */2][/* e */4]);
  return newState(machineCycles(1, cpu$1), undefined, undefined, s);
}

function xor_h(s) {
  var cpu = s[/* cpu */0];
  var cpu$1 = xor_(cpu, cpu[/* registers */2][/* h */5]);
  return newState(machineCycles(1, cpu$1), undefined, undefined, s);
}

function xor_l(s) {
  var cpu = s[/* cpu */0];
  var cpu$1 = xor_(cpu, cpu[/* registers */2][/* l */6]);
  return newState(machineCycles(1, cpu$1), undefined, undefined, s);
}
...
function add_a(cpu, value) {
  ...
  var bool = a$prime > 65535;
  var fC = bool ? 1 : 0;
  var bool$1 = isHalfCarry(a, value);
  var fH = bool$1 ? 1 : 0;
  var fZ = a$prime === 0 ? 1 : 0;
  var partial_arg = a$prime & 255;
  return (function (eta) {
              ...
              return setRegisters(partial_arg, param, param$1, param$2, param$3, param$4, param$5, param$6, param$7);
                  ...
                  var param = undefined;
                  var param$1 = eta;
                  return setFlag$1(/* C */3, fC, param, param$1);
                })((function (eta) {
                      var param = undefined;
                      var param$1 = eta;
                      return setFlag$1(/* H */2, fH, param, param$1);
                    })((function (eta) {
                          var param = undefined;
                          var param$1 = eta;
                          return setFlag$1(/* N */1, 0, param, param$1);
...
function add_a_a(s) {
  var cpu = s[/* cpu */0];
  var cpu$1 = add_a(cpu, cpu[/* registers */2][/* a */0]);
  return newState(machineCycles(1, cpu$1), undefined, undefined, s);
}

function add_a_b(s) {
  var cpu = s[/* cpu */0];
  var cpu$1 = add_a(cpu, cpu[/* registers */2][/* b */1]);
  return newState(machineCycles(1, cpu$1), undefined, undefined, s);
}

function add_a_c(s) {
  var cpu = s[/* cpu */0];
  var cpu$1 = add_a(cpu, cpu[/* registers */2][/* c */2]);
  return newState(machineCycles(1, cpu$1), undefined, undefined, s);
}

function add_a_d(s) {
  var cpu = s[/* cpu */0];
  var cpu$1 = add_a(cpu, cpu[/* registers */2][/* d */3]);
  return newState(machineCycles(1, cpu$1), undefined, undefined, s);
}

function add_a_e(s) {
  var cpu = s[/* cpu */0];
  var cpu$1 = add_a(cpu, cpu[/* registers */2][/* e */4]);
  return newState(machineCycles(1, cpu$1), undefined, undefined, s);
}

function add_a_h(s) {
  var cpu = s[/* cpu */0];
  var cpu$1 = add_a(cpu, cpu[/* registers */2][/* h */5]);
  return newState(machineCycles(1, cpu$1), undefined, undefined, s);
}

function add_a_l(s) {
  var cpu = s[/* cpu */0];
  var cpu$1 = add_a(cpu, cpu[/* registers */2][/* l */6]);
  return newState(machineCycles(1, cpu$1), undefined, undefined, s);
}
...
function add_a_n(s) {
  ...
  var cpu$1 = add_a(cpu, match[0]);
  return newState(incrementPc(1, machineCycles(2, cpu$1)), Caml_option.some(match[1]), undefined, s);
}

function adc_a_a(s) {
  var cpu = s[/* cpu */0];
  var carry = getFlag(/* C */3, cpu[/* registers */2][/* f */7]);
  var cpu$1 = add_a(cpu, cpu[/* registers */2][/* a */0] + carry | 0);
  return newState(machineCycles(1, cpu$1), undefined, undefined, s);
}
...
function adc_a_b(s) {
  var cpu = s[/* cpu */0];
  var carry = getFlag(/* C */3, cpu[/* registers */2][/* f */7]);
  var cpu$1 = add_a(cpu, cpu[/* registers */2][/* b */1] + carry | 0);
  return newState(machineCycles(1, cpu$1), undefined, undefined, s);
}
...
function adc_a_c(s) {
  var cpu = s[/* cpu */0];
  var carry = getFlag(/* C */3, cpu[/* registers */2][/* f */7]);
  var cpu$1 = add_a(cpu, cpu[/* registers */2][/* c */2] + carry | 0);
  return newState(machineCycles(1, cpu$1), undefined, undefined, s);
}
...
function adc_a_d(s) {
  var cpu = s[/* cpu */0];
  var carry = getFlag(/* C */3, cpu[/* registers */2][/* f */7]);
  var cpu$1 = add_a(cpu, cpu[/* registers */2][/* d */3] + carry | 0);
  return newState(machineCycles(1, cpu$1), undefined, undefined, s);
}
...
function adc_a_e(s) {
  var cpu = s[/* cpu */0];
  var carry = getFlag(/* C */3, cpu[/* registers */2][/* f */7]);
  var cpu$1 = add_a(cpu, cpu[/* registers */2][/* e */4] + carry | 0);
  return newState(machineCycles(1, cpu$1), undefined, undefined, s);
}
...
function adc_a_h(s) {
  var cpu = s[/* cpu */0];
  var carry = getFlag(/* C */3, cpu[/* registers */2][/* f */7]);
  var cpu$1 = add_a(cpu, cpu[/* registers */2][/* h */5] + carry | 0);
  return newState(machineCycles(1, cpu$1), undefined, undefined, s);
}
...
function adc_a_l(s) {
  var cpu = s[/* cpu */0];
  var carry = getFlag(/* C */3, cpu[/* registers */2][/* f */7]);
  var cpu$1 = add_a(cpu, cpu[/* registers */2][/* l */6] + carry | 0);
  return newState(machineCycles(1, cpu$1), undefined, undefined, s);
}
...
function add_hl(cpu, value) {
  ...
  var bool$1 = isHalfCarry(rHl(cpu), value);
  ...
  return /* tuple */[
          machineCycles(2, (function (eta) {
                    ...
                    return setFlag$1(/* C */3, partial_arg, param, param$1);
                        ...
                        var param = undefined;
                        var param$1 = eta;
                        return setFlag$1(/* H */2, partial_arg$1, param, param$1);
                      })((function (eta) {
                            var param = undefined;
                            var param$1 = eta;
                            return setFlag$1(/* N */1, 0, param, param$1);
...
function sub(cpu, value) {
  ...
  var a = match[/* a */0];
  var a$prime = a - value | 0;
  var bool = Caml_obj.caml_lessthan(a, value);
  var fC = bool ? 1 : 0;
  var bool$1 = isHalfBorrow(a, value);
  var fH = bool$1 ? 1 : 0;
  var fZ = a$prime === 0 ? 1 : 0;
  var partial_arg = a$prime & 255;
  return (function (eta) {
...
function sub_a(s) {
  var cpu = s[/* cpu */0];
  var cpu$1 = sub(cpu, cpu[/* registers */2][/* a */0]);
  return newState(machineCycles(1, cpu$1), undefined, undefined, s);
}

function sub_b(s) {
  var cpu = s[/* cpu */0];
  var cpu$1 = sub(cpu, cpu[/* registers */2][/* b */1]);
  return newState(machineCycles(1, cpu$1), undefined, undefined, s);
}

function sub_c(s) {
  var cpu = s[/* cpu */0];
  var cpu$1 = sub(cpu, cpu[/* registers */2][/* c */2]);
  return newState(machineCycles(1, cpu$1), undefined, undefined, s);
}

function sub_d(s) {
  var cpu = s[/* cpu */0];
  var cpu$1 = sub(cpu, cpu[/* registers */2][/* d */3]);
  return newState(machineCycles(1, cpu$1), undefined, undefined, s);
}

function sub_e(s) {
  var cpu = s[/* cpu */0];
  var cpu$1 = sub(cpu, cpu[/* registers */2][/* e */4]);
  return newState(machineCycles(1, cpu$1), undefined, undefined, s);
}

function sub_h(s) {
  var cpu = s[/* cpu */0];
  var cpu$1 = sub(cpu, cpu[/* registers */2][/* h */5]);
  return newState(machineCycles(1, cpu$1), undefined, undefined, s);
}

function sub_l(s) {
  var cpu = s[/* cpu */0];
  var cpu$1 = sub(cpu, cpu[/* registers */2][/* l */6]);
  return newState(machineCycles(1, cpu$1), undefined, undefined, s);
}
...
function sbc_a(s) {
  var cpu = s[/* cpu */0];
  var carry = getFlag(/* C */3, cpu[/* registers */2][/* f */7]);
  var cpu$1 = sub(cpu, cpu[/* registers */2][/* a */0] + carry | 0);
  return newState(machineCycles(1, cpu$1), undefined, undefined, s);
}
...
function sbc_b(s) {
  var cpu = s[/* cpu */0];
  var carry = getFlag(/* C */3, cpu[/* registers */2][/* f */7]);
  var cpu$1 = sub(cpu, cpu[/* registers */2][/* b */1] + carry | 0);
  return newState(machineCycles(1, cpu$1), undefined, undefined, s);
}
...
function sbc_c(s) {
  var cpu = s[/* cpu */0];
  var carry = getFlag(/* C */3, cpu[/* registers */2][/* f */7]);
  var cpu$1 = sub(cpu, cpu[/* registers */2][/* c */2] + carry | 0);
  return newState(machineCycles(1, cpu$1), undefined, undefined, s);
}
...
function sbc_d(s) {
  var cpu = s[/* cpu */0];
  var carry = getFlag(/* C */3, cpu[/* registers */2][/* f */7]);
  var cpu$1 = sub(cpu, cpu[/* registers */2][/* d */3] + carry | 0);
  return newState(machineCycles(1, cpu$1), undefined, undefined, s);
}
...
function sbc_e(s) {
  var cpu = s[/* cpu */0];
  var carry = getFlag(/* C */3, cpu[/* registers */2][/* f */7]);
  var cpu$1 = sub(cpu, cpu[/* registers */2][/* e */4] + carry | 0);
  return newState(machineCycles(1, cpu$1), undefined, undefined, s);
}
...
function sbc_h(s) {
  var cpu = s[/* cpu */0];
  var carry = getFlag(/* C */3, cpu[/* registers */2][/* f */7]);
  var cpu$1 = sub(cpu, cpu[/* registers */2][/* h */5] + carry | 0);
  return newState(machineCycles(1, cpu$1), undefined, undefined, s);
}
...
function sbc_l(s) {
  var cpu = s[/* cpu */0];
  var carry = getFlag(/* C */3, cpu[/* registers */2][/* f */7]);
  var cpu$1 = sub(cpu, cpu[/* registers */2][/* l */6] + carry | 0);
  return newState(machineCycles(1, cpu$1), undefined, undefined, s);
}
...
function and_a(s) {
  var cpu = s[/* cpu */0];
  var cpu$1 = and_(cpu, cpu[/* registers */2][/* a */0]);
  return newState(machineCycles(1, cpu$1), undefined, undefined, s);
}

function and_b(s) {
  var cpu = s[/* cpu */0];
  var cpu$1 = and_(cpu, cpu[/* registers */2][/* b */1]);
  return newState(machineCycles(1, cpu$1), undefined, undefined, s);
}

function and_c(s) {
  var cpu = s[/* cpu */0];
  var cpu$1 = and_(cpu, cpu[/* registers */2][/* c */2]);
  return newState(machineCycles(1, cpu$1), undefined, undefined, s);
}

function and_d(s) {
  var cpu = s[/* cpu */0];
  var cpu$1 = and_(cpu, cpu[/* registers */2][/* d */3]);
  return newState(machineCycles(1, cpu$1), undefined, undefined, s);
}

function and_e(s) {
  var cpu = s[/* cpu */0];
  var cpu$1 = and_(cpu, cpu[/* registers */2][/* e */4]);
  return newState(machineCycles(1, cpu$1), undefined, undefined, s);
}

function and_h(s) {
  var cpu = s[/* cpu */0];
  var cpu$1 = and_(cpu, cpu[/* registers */2][/* h */5]);
  return newState(machineCycles(1, cpu$1), undefined, undefined, s);
}

function and_l(s) {
  var cpu = s[/* cpu */0];
  var cpu$1 = and_(cpu, cpu[/* registers */2][/* l */6]);
  return newState(machineCycles(1, cpu$1), undefined, undefined, s);
}
...
function cp(cpu, value) {
  ...
  var bool = Caml_obj.caml_lessthan(a, value);
  var fC = bool ? 1 : 0;
  var bool$1 = isHalfBorrow$1(a, value);
  var fH = bool$1 ? 1 : 0;
  var fZ = a$prime === 0 ? 1 : 0;
  return (function (eta) {
              var param = undefined;
...
function cp_a(s) {
  var cpu = s[/* cpu */0];
  var cpu$1 = cp(cpu, cpu[/* registers */2][/* a */0]);
  return newState(machineCycles(1, cpu$1), undefined, undefined, s);
}

function cp_b(s) {
  var cpu = s[/* cpu */0];
  var cpu$1 = cp(cpu, cpu[/* registers */2][/* b */1]);
  return newState(machineCycles(1, cpu$1), undefined, undefined, s);
}

function cp_c(s) {
  var cpu = s[/* cpu */0];
  var cpu$1 = cp(cpu, cpu[/* registers */2][/* c */2]);
  return newState(machineCycles(1, cpu$1), undefined, undefined, s);
}

function cp_d(s) {
  var cpu = s[/* cpu */0];
  var cpu$1 = cp(cpu, cpu[/* registers */2][/* d */3]);
  return newState(machineCycles(1, cpu$1), undefined, undefined, s);
}

function cp_e(s) {
  var cpu = s[/* cpu */0];
  var cpu$1 = cp(cpu, cpu[/* registers */2][/* e */4]);
  return newState(machineCycles(1, cpu$1), undefined, undefined, s);
}

function cp_h(s) {
  var cpu = s[/* cpu */0];
  var cpu$1 = cp(cpu, cpu[/* registers */2][/* h */5]);
  return newState(machineCycles(1, cpu$1), undefined, undefined, s);
}

function cp_l(s) {
  var cpu = s[/* cpu */0];
  var cpu$1 = cp(cpu, cpu[/* registers */2][/* l */6]);
  return newState(machineCycles(1, cpu$1), undefined, undefined, s);
}
...
function jr_n(s) {
  ...
  return newState(machineCycles(2, incrementPc(signed(match[0]) + 1 | 0, cpu)), Caml_option.some(match[1]), undefined, s);
}
...
function jr_nz_n(s) {
  ...
  return newState(machineCycles(match$1[1], incrementPc(match$1[0], cpu)), Caml_option.some(match[1]), undefined, s);
}
...
function ret_(cpu, mmu, gpu) {
  var match = Mmu$GameboyEmulator.read16(cpu[/* registers */2][/* sp */8], /* record */[
        /* gpu */gpu,
        /* mmu */mmu
      ]);
  var cpu$1 = setPc(match[0], cpu);
  cpu$1[/* registers */2][/* sp */8] = cpu$1[/* registers */2][/* sp */8] + 2 | 0;
  return /* tuple */[
          cpu$1,
          match[1]
        ];
...
function ret(s) {
  ...
  return newState(machineCycles(2, match[0]), Caml_option.some(match[1]), undefined, s);
}
...
function ret_nz(s) {
  ...
  if (isSet(/* Z */0, cpu[/* registers */2][/* f */7])) {
    ...
    match = /* tuple */[
      machineCycles(3, match$1[0]),
      match$1[1]
    ];
  }
  return newState(match[0], Caml_option.some(match[1]), undefined, s);
}
...
function swap(cpu, value) {
  var nibble1 = value & 15;
  var nibble2 = value & 240;
  var swapped = nibble1 + nibble2 | 0;
  var partial_arg = swapped === 0 ? 1 : 0;
  return /* tuple */[
          swapped,
          (function (eta) {
                var param = undefined;
                ...
                return setFlag$1(/* C */3, 0, param, param$1);
                    ...
                    return setFlag$1(/* H */2, 0, param, param$1);
                        ...
                        return setFlag$1(/* N */1, 0, param, param$1);
                            ...
                            var param = undefined;
                            var param$1 = eta;
                            return setFlag$1(/* Z */0, partial_arg, param, param$1);
                          })(cpu))))
        ];
}
...
function swap_a(s) {
  ...
  var partial_arg = match[0];
  return newState(machineCycles(2, (function (eta) {
                      var param = undefined;
                      var param$1 = undefined;
                      var param$2 = undefined;
                      var param$3 = undefined;
...
function swap_c(s) {
  ...
  var arg = match[0];
  return newState(machineCycles(2, (function (param, param$1) {
                        return (function (param$2, param$3, param$4, param$5, param$6, param$7) {
                            return setRegisters(param, param$1, arg, param$2, param$3, param$4, param$5, param$6, param$7);
                          });
                      })(undefined, undefined)(undefined, undefined, undefined, undefined, undefined, match[1])), undefined, undefined, s);
...
function cb_exec(param) {
  var gpu = param[/* gpu */2];
  var match = readAndIncrementPc(param[/* cpu */0]);
  var match$1 = Mmu$GameboyEmulator.read8(match[0], /* record */[
        /* gpu */gpu,
        /* mmu */param[/* mmu */1]
      ]);
  var nextInstr = match$1[0];
  var cbop = nextInstr !== 48 ? (
      nextInstr !== 55 ? nop : swap_a
    ) : swap_b;
