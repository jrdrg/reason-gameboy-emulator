...
function load_nn_8(register, s) {
  ...
  switch (register) {
    ...
    case /* B */1 :
        var arg = value;
        cpu$1 = Cpu$GameboyEmulator.machineCycles(2, Curry._7((function (param) {
    ...
    case /* C */2 :
        var arg$1 = value;
        cpu$1 = Cpu$GameboyEmulator.machineCycles(2, Curry._6((function (param, param$1) {
                      return (function (param$2, param$3, param$4, param$5, param$6, param$7) {
                          return Cpu$GameboyEmulator.setRegisters(param, param$1, arg$1, param$2, param$3, param$4, param$5, param$6, param$7);
                        });
                    })(undefined, undefined), undefined, undefined, undefined, undefined, undefined, cpu));
        break;
    case /* D */3 :
        var arg$2 = value;
        cpu$1 = Cpu$GameboyEmulator.machineCycles(2, Curry._5((function (param, param$1, param$2) {
                      return (function (param$3, param$4, param$5, param$6, param$7) {
                          return Cpu$GameboyEmulator.setRegisters(param, param$1, param$2, arg$2, param$3, param$4, param$5, param$6, param$7);
                        });
                    })(undefined, undefined, undefined), undefined, undefined, undefined, undefined, cpu));
        break;
    case /* E */4 :
        var arg$3 = value;
        cpu$1 = Cpu$GameboyEmulator.machineCycles(2, Curry._4((function (param, param$1, param$2, param$3) {
                      return (function (param$4, param$5, param$6, param$7) {
                          return Cpu$GameboyEmulator.setRegisters(param, param$1, param$2, param$3, arg$3, param$4, param$5, param$6, param$7);
                        });
                    })(undefined, undefined, undefined, undefined), undefined, undefined, undefined, cpu));
        break;
    case /* F */5 :
    ...
    case /* H */6 :
        var arg$4 = value;
        cpu$1 = Cpu$GameboyEmulator.machineCycles(2, Curry._3((function (param, param$1, param$2, param$3, param$4) {
                      return (function (param$5, param$6, param$7) {
                          return Cpu$GameboyEmulator.setRegisters(param, param$1, param$2, param$3, param$4, arg$4, param$5, param$6, param$7);
                        });
                    })(undefined, undefined, undefined, undefined, undefined), undefined, undefined, cpu));
        break;
    case /* L */7 :
        var arg$5 = value;
        cpu$1 = Cpu$GameboyEmulator.machineCycles(2, Curry._2((function (param, param$1, param$2, param$3, param$4, param$5) {
                      return (function (param$6, param$7) {
                          return Cpu$GameboyEmulator.setRegisters(param, param$1, param$2, param$3, param$4, param$5, arg$5, param$6, param$7);
                        });
                    })(undefined, undefined, undefined, undefined, undefined, undefined), undefined, cpu));
        break;
    
  }
  return Cpu_types$GameboyEmulator.newState(cpu$1, Caml_option.some(match$1[1]), undefined, s);
}
...
function ld_sp_nn(s) {
  ...
  return Cpu_types$GameboyEmulator.newState(Cpu$GameboyEmulator.incrementPc(2, Cpu$GameboyEmulator.machineCycles(3, Cpu$GameboyEmulator.setSp(match[0], cpu))), Caml_option.some(match[1]), undefined, s);
}
...
function ld_hl_sp_n(s) {
  ...
  var n = Cpu$GameboyEmulator.signed(match[0]) + cpu[/* registers */2][/* sp */8] | 0;
...
function adc_a_a(s) {
  var cpu = s[/* cpu */0];
  var carry = Cpu$GameboyEmulator.Flags.getFlag(/* C */3, cpu[/* registers */2][/* f */7]);
...
function jp_m_hl(s) {
  var cpu = s[/* cpu */0];
  cpu[/* registers */2][/* pc */9] = Cpu$GameboyEmulator.rHl(cpu);
...
function jp_nz_nn(s) {
  ...
  var cpu = s[/* cpu */0];
  var match;
  if (Cpu$GameboyEmulator.Flags.isSet(/* Z */0, cpu[/* registers */2][/* f */7])) {
...
function jp_nc_nn(s) {
  ...
  var cpu = s[/* cpu */0];
  var match;
  if (Cpu$GameboyEmulator.Flags.isSet(/* C */3, cpu[/* registers */2][/* f */7])) {
    var pc$prime = Cpu$GameboyEmulator.programCount(cpu) + 2 | 0;
    match = /* tuple */[
      pc$prime,
      mmu,
...
function jr_nz_n(s) {
  ...
  var match$1 = Cpu$GameboyEmulator.Flags.isSet(/* Z */0, cpu[/* registers */2][/* f */7]) ? /* tuple */[
      pc + 1 | 0,
      2
    ] : /* tuple */[
...
function jr_nc_n(s) {
  ...
  var match$1 = Cpu$GameboyEmulator.Flags.isSet(/* C */3, cpu[/* registers */2][/* f */7]) ? /* tuple */[
      pc + 1 | 0,
      2
    ] : /* tuple */[
      (pc + 1 | 0) + Cpu$GameboyEmulator.signed(match[0]) | 0,
...
function call(param) {
  ...
  var match = Mmu$GameboyEmulator.write16(cpu[/* registers */2][/* sp */8], Cpu$GameboyEmulator.programCount(cpu) + 2 | 0, /* record */[
        /* gpu */param[/* gpu */2],
        /* mmu */param[/* mmu */1]
      ]);
  var match$1 = Mmu$GameboyEmulator.read16(Cpu$GameboyEmulator.programCount(cpu), /* record */[
...
function cb_exec(param) {
  ...
  var cbop = nextInstr !== 48 ? (
      nextInstr !== 55 ? nop : Cpu_cbops$GameboyEmulator.Swap.swap_a
    ) : Cpu_cbops$GameboyEmulator.Swap.swap_b;
