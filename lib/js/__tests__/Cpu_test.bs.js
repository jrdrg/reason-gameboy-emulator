        ...
        return Jest.describe("Ops", (function (param) {
                      Jest.describe("Increment", (function (param) {
                              ...
                              Jest.describe("INC B", (function (param) {
                                      Jest.test("increments register b", (function (param) {
                                              ...
                                              var cpu1 = Curry._1(Cpu$GameboyEmulator.Ops[/* Increment8 */6][/* inc_b */2], /* record */[
                                                      /* cpu */match[0],
                                                      /* mmu */match[1],
                                                      /* gpu */match[2]
                                                    ])[/* cpu */0];
                              ...
                              Jest.describe("INC C", (function (param) {
                                      Jest.test("increments register c", (function (param) {
                                              ...
                                              var cpu1 = Curry._1(Cpu$GameboyEmulator.Ops[/* Increment8 */6][/* inc_c */3], /* record */[
                                                      /* cpu */match[0],
                                                      /* mmu */match[1],
                                                      /* gpu */match[2]
                                                    ])[/* cpu */0];
                              ...
                              Jest.test("INC BC", (function (param) {
                                      var match = makeState(undefined, undefined, 255, undefined, undefined, /* () */0);
                                      var cpu1 = Curry._1(Cpu$GameboyEmulator.Ops[/* Increment16 */5][/* inc_bc */0], /* record */[
                                              /* cpu */match[0],
                                              /* mmu */match[1],
                                              /* gpu */match[2]
                                            ])[/* cpu */0];
                              ...
                              Jest.test("INC DE", (function (param) {
                                      ...
                                      var mmu = Mmu$GameboyEmulator.load(Caml_array.caml_make_vect(4096, 0));
                                      var gpu = Gpu$GameboyEmulator.make(/* () */0);
                                      var cpu1 = Curry._1(Cpu$GameboyEmulator.Ops[/* Increment16 */5][/* inc_de */1], /* record */[
                                              /* cpu */cpu,
                                              /* mmu */mmu,
                                              /* gpu */gpu
                                            ])[/* cpu */0];
                              ...
                              return Jest.test("INC HL", (function (param) {
                                            ...
                                            var mmu = Mmu$GameboyEmulator.load(Caml_array.caml_make_vect(4096, 0));
                                            var gpu = Gpu$GameboyEmulator.make(/* () */0);
                                            var cpu1 = Curry._1(Cpu$GameboyEmulator.Ops[/* Increment16 */5][/* inc_hl */2], /* record */[
                                                    /* cpu */cpu,
                                                    /* mmu */mmu,
                                                    /* gpu */gpu
                                                  ])[/* cpu */0];
                      ...
                      Jest.describe("Decrement", (function (param) {
                              Jest.test("DEC BC", (function (param) {
                                      ...
                                      var mmu = Mmu$GameboyEmulator.load(Caml_array.caml_make_vect(4096, 0));
                                      var gpu = Gpu$GameboyEmulator.make(/* () */0);
                                      var cpu1 = Curry._1(Cpu$GameboyEmulator.Ops[/* Decrement16 */11][/* dec_bc */0], /* record */[
                                              /* cpu */cpu,
                                              /* mmu */mmu,
                                              /* gpu */gpu
                                            ])[/* cpu */0];
                              ...
                              Jest.test("DEC DE", (function (param) {
                                      ...
                                      var mmu = Mmu$GameboyEmulator.load(Caml_array.caml_make_vect(4096, 0));
                                      var gpu = Gpu$GameboyEmulator.make(/* () */0);
                                      var cpu1 = Curry._1(Cpu$GameboyEmulator.Ops[/* Decrement16 */11][/* dec_de */1], /* record */[
                                              /* cpu */cpu,
                                              /* mmu */mmu,
                                              /* gpu */gpu
                                            ])[/* cpu */0];
                              ...
                              return Jest.test("DEC HL", (function (param) {
                                            ...
                                            var mmu = Mmu$GameboyEmulator.load(Caml_array.caml_make_vect(4096, 0));
                                            var gpu = Gpu$GameboyEmulator.make(/* () */0);
                                            var cpu1 = Curry._1(Cpu$GameboyEmulator.Ops[/* Decrement16 */11][/* dec_hl */2], /* record */[
                                                    /* cpu */cpu,
                                                    /* mmu */mmu,
                                                    /* gpu */gpu
                                                  ])[/* cpu */0];
                      ...
                      return Jest.testAll("RLCA", /* :: */[
                                  ...
                                  /* :: */[
                                    ...
                                    var mmu = Mmu$GameboyEmulator.load(Caml_array.caml_make_vect(4096, 0));
                                    var gpu = Gpu$GameboyEmulator.make(/* () */0);
                                    var cpu1 = Curry._1(Cpu$GameboyEmulator.Ops[/* Rotation */12][/* rlca */0], /* record */[
                                            /* cpu */cpu,
                                            /* mmu */mmu,
                                            /* gpu */gpu
                                          ])[/* cpu */0];
