        ...
        return Jest.describe("Ops", (function (param) {
                      ...
                      Jest.describe("Add", (function (param) {
                              Jest.test("updates the register", (function (param) {
                                      ...
                                      var mmu = Mmu$GameboyEmulator.load(Caml_array.caml_make_vect(4096, 0));
                                      var gpu = Gpu$GameboyEmulator.make(/* () */0);
                                      var cpu1 = Curry._1(Cpu$GameboyEmulator.Ops[/* Add_16 */17][/* add_hl_bc */3], /* record */[
                                              /* cpu */cpu,
                                              /* mmu */mmu,
                                              /* gpu */gpu
                                            ])[/* cpu */0];
                      ...
                      Jest.describe("Push/Pop", (function (param) {
                              ...
                              generateTest("AF", /* AF */0, Cpu$GameboyEmulator.Ops[/* Push */14][/* push_af */1], Cpu$GameboyEmulator.Ops[/* Pop */15][/* pop_af */1], Cpu$GameboyEmulator.rAf);
                              generateTest("BC", /* BC */1, Cpu$GameboyEmulator.Ops[/* Push */14][/* push_bc */2], Cpu$GameboyEmulator.Ops[/* Pop */15][/* pop_bc */2], Cpu$GameboyEmulator.rBc);
                              generateTest("DE", /* DE */2, Cpu$GameboyEmulator.Ops[/* Push */14][/* push_de */3], Cpu$GameboyEmulator.Ops[/* Pop */15][/* pop_de */3], Cpu$GameboyEmulator.rDe);
                              return generateTest("HL", /* HL */3, Cpu$GameboyEmulator.Ops[/* Push */14][/* push_hl */4], Cpu$GameboyEmulator.Ops[/* Pop */15][/* pop_hl */4], Cpu$GameboyEmulator.rHl);
                            }));
                      Jest.describe("AND", (function (param) {
                              ...
                              Jest.test("A", (function (param) {
                                      ...
                                      var cpu1 = Curry._1(Cpu$GameboyEmulator.Ops[/* And */19][/* and_a */1], /* record */[
                                              /* cpu */cpu,
                                              /* mmu */match[0],
                                              /* gpu */match[1]
                                            ])[/* cpu */0];
                                      return Jest.Expect[/* toBe */2](85, Jest.Expect[/* expect */0](cpu1[/* registers */2][/* a */0]));
                                    }));
                              Jest.test("B", (function (param) {
                                      ...
                                      var cpu1 = Curry._1(Cpu$GameboyEmulator.Ops[/* And */19][/* and_b */2], /* record */[
                                              /* cpu */cpu,
                                              /* mmu */match[0],
                                              /* gpu */match[1]
                                            ])[/* cpu */0];
                                      return Jest.Expect[/* toBe */2](1, Jest.Expect[/* expect */0](cpu1[/* registers */2][/* a */0]));
                                    }));
                              return Jest.test("C", (function (param) {
                                            ...
                                            var cpu1 = Curry._1(Cpu$GameboyEmulator.Ops[/* And */19][/* and_c */3], /* record */[
                                                    /* cpu */cpu,
                                                    /* mmu */match[0],
                                                    /* gpu */match[1]
                                                  ])[/* cpu */0];
                      ...
                      Jest.describe("LD_B_N", (function (param) {
                              Jest.test("B", (function (param) {
                                      ...
                                      var gpu = match$1[1];
                                      var mmu = match$1[0];
                                      var cpu1 = Curry._1(Cpu$GameboyEmulator.Ops[/* Load_nn_8 */2][/* ld_b_n */1], /* record */[
                                              /* cpu */cpu,
                                              /* mmu */mmu,
                                              /* gpu */gpu
                                            ])[/* cpu */0];
                                      var cpu2 = Curry._2(Cpu$GameboyEmulator.Ops[/* Load_nn_8 */2][/* load_nn_8 */0], /* C */2, /* record */[
                                              /* cpu */cpu,
                                              /* mmu */mmu,
                                              /* gpu */gpu
                                            ])[/* cpu */0];
                                      return Jest.Expect[/* toEqual */12](cpu2, Jest.Expect[/* expect */0](cpu1));
                                    }));
                              Jest.test("B", (function (param) {
                                      var match = initialValues(/* () */0);
                                      var cpu = Cpu$GameboyEmulator.setPc(57344, Cpu$GameboyEmulator.make(/* () */0));
                                      ...
                                      return Jest.Expect[/* toEqual */12](64, Jest.Expect[/* expect */0](cpu1[/* registers */2][/* b */1]));
                                    }));
                              return Jest.test("PC", (function (param) {
                                            var match = initialValues(/* () */0);
                                            var cpu = Cpu$GameboyEmulator.setPc(57344, Cpu$GameboyEmulator.make(/* () */0));
                                            var cpu1 = Curry._2(Cpu$GameboyEmulator.Ops[/* Load_nn_8 */2][/* load_nn_8 */0], /* C */2, /* record */[
                                                    /* cpu */cpu,
                                                    /* mmu */match[0],
                                                    /* gpu */match[1]
                                                  ])[/* cpu */0];
                                            return Jest.Expect[/* toEqual */12](57345, Jest.Expect[/* expect */0](cpu1[/* registers */2][/* pc */9]));
                                          }));
                            }));
