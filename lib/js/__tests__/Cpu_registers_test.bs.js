...
Jest.describe("Cpu registers", (function (param) {
        Jest.describe("8-bit registers", (function (param) {
                Jest.test("A", (function (param) {
                        ...
                        return Jest.Expect.toBe(3, Jest.Expect.expect(cpu[/* registers */2][/* a */0]));
                      }));
                Jest.test("B", (function (param) {
                        ...
                        return Jest.Expect.toBe(3, Jest.Expect.expect(cpu[/* registers */2][/* b */1]));
                      }));
                Jest.test("C", (function (param) {
                        ...
                        return Jest.Expect.toBe(3, Jest.Expect.expect(cpu[/* registers */2][/* c */2]));
                      }));
                Jest.test("D", (function (param) {
                        ...
                        return Jest.Expect.toBe(3, Jest.Expect.expect(cpu[/* registers */2][/* d */3]));
                      }));
                Jest.test("E", (function (param) {
                        ...
                        return Jest.Expect.toBe(3, Jest.Expect.expect(cpu[/* registers */2][/* e */4]));
                      }));
                Jest.test("H", (function (param) {
                        ...
                        return Jest.Expect.toBe(3, Jest.Expect.expect(cpu[/* registers */2][/* h */5]));
                      }));
                return Jest.test("L", (function (param) {
                              ...
                              return Jest.Expect.toBe(3, Jest.Expect.expect(cpu[/* registers */2][/* l */6]));
                            }));
              }));
