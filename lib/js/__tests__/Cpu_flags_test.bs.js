...
Jest.describe("Cpu Flags", (function (param) {
        Jest.testAll("Setting flags", /* :: */[
              ...
              /* :: */[
                ...
                return Jest.Expect.toBe(param[1], Jest.Expect.expect(Cpu$GameboyEmulator.getFlag(flag, cpu)));
              }));
        Jest.testAll("Setting a flag with an initial value", /* :: */[
              ...
              /* :: */[
                ...
                return Jest.Expect.toBe(param[2], Jest.Expect.expect(cpu[/* registers */2][/* f */7]));
              }));
        return Jest.testAll("Getting a flag's value", /* :: */[
                    ...
                    /* :: */[
                      ...
                      return Jest.Expect.toBe(param[2], Jest.Expect.expect(Cpu$GameboyEmulator.Flags.getFlag(param[0], cpu[/* registers */2][/* f */7])));
                    }));
      }));
